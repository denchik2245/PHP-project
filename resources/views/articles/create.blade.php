    ...
    <div class="card" style="max-width: 900px; margin: 0 auto;">
        ...
        <form action="{{ route('my.articles.store') }}" method="POST">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <textarea id="content" name="content" rows="12" style="width: 100%; padding: 10px; margin-top: 6px;">{{ old('content') }}</textarea>
            </div>

            <button type="submit" class="btn" style="border: none; cursor: pointer;">Сохранить как черновик</button>
        </form>
    </div>
@endsection